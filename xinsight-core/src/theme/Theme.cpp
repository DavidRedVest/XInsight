...
Theme builtinEyeCareTheme() {
    ...
    theme.editor = EditorColors{
        ...
        .lineNumberForeground = {0x6B, 0x8F, 0x73},
        .lineNumberBackground = {0xBF, 0xE5, 0xC5},
    };
    theme.tokenColors = makeTokenColors({
        {"comment", {0x6B, 0x8F, 0x73}},
        {"string", {0x8B, 0x69, 0x14}},
        {"character", {0x8B, 0x69, 0x14}},
        {"number", {0x5B, 0x7F, 0x5B}},
        {"boolean", {0x2C, 0x5F, 0x8A}},
        {"keyword", {0x2C, 0x5F, 0x8A}},
        {"attribute", {0x2C, 0x5F, 0x8A}},
        {"type", {0x4A, 0x7A, 0x6E}},
        {"module", {0x4A, 0x7A, 0x6E}},
        {"constructor", {0x4A, 0x7A, 0x6E}},
        {"function", {0x7A, 0x6B, 0x2C}},
        {"variable", {0x2C, 0x4A, 0x5F}},
        {"property", {0x2C, 0x4A, 0x5F}},
        {"label", {0x2C, 0x4A, 0x5F}},
        {"constant", {0x3A, 0x6B, 0x8A}},
